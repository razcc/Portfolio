...
import { faUserSecret, faBars, faAnglesDown, faChevronLeft, faChevronRight, faX, faEnvelope} from '@fortawesome/free-solid-svg-icons'
...
library.add(faUserSecret, faChevronLeft, faChevronRight, faBars, faAnglesDown, gitHubBrand, linkedinBrand, codePenBrand, InstagramBrand, html, css, bootstrap, js, vue, php, laravel, faX,faEnvelope)
