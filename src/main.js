...
library.add(faUserSecret, faChevronLeft,faArrowLeft, faChevronRight, faBars, faAnglesDown, gitHubBrand, linkedinBrand, codePenBrand, InstagramBrand, html, css, bootstrap, js, vue, php, laravel, faX,faEnvelope)
